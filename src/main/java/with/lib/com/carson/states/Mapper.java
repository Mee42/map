        ...
        while(true) {
            ...
            switch (in.toUpperCase()) {
                ...
                case "GET":
                    ...
                    for (State s : db.getAllNodesWithConnections()){
                        str += s + " ";
                    }
